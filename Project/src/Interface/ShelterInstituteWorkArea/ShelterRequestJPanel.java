 ...
 * @author liulei
 */
public class ShelterRequestJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form ShelterRequestJPanel
     */

    ShelterRequestJPanel(JPanel userProcessContainer, UserAccount account, Enterprise enterprise, EcoSystem system, ReportWorkRequest request, ShelterInstitute shelterinstitute) {
        initComponents();
    this.userProcessContainer = userProcessContainer;
        ...
        txtRequest.setText(String.valueOf(request.getShelterquantity()));
        
        for(Inventory i : si.getInventoryDirectory().getInventoryList()){
            siList.add((ShelterInventory) i);
        }
        populateInventoryTable();
        txtName.setText(request.getGender());
    ...
    private void initComponents() {
        ...
        enterpriseLabel.setText("Shelter Institution Report Work Area:");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                            .addComponent(labelName, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(18, 18, 18)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(labelName, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnApproveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApproveActionPerformed
        ...
        ShelterInventory si = (ShelterInventory)tblInventory.getValueAt(selectedRow, 0);
        int requestN = request.getShelterquantity();
                int quantity = si.getInventory();
                if(requestN>quantity){
                    JOptionPane.showMessageDialog(null, "The inventory isn't enough! ");
                }
                else if(!si.getTargetGender().equals(txtName.getText())){
                    JOptionPane.showMessageDialog(null, "You cannot assign the homeless to an opposite shelter");
                }
                else{
                si.setInventory(quantity-requestN);
                ...
                request.setStatus("ShelterInstitution Completed");
                populateInventoryTable();
