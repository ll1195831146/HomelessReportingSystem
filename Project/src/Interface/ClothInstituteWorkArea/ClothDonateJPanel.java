 ...
 * @author liulei
 */
public class ClothDonateJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form ClothDonateJPanel
     */

    ClothDonateJPanel(JPanel userProcessContainer, UserAccount account, Enterprise enterprise, EcoSystem system, ClothInstitute clothinstitute) {
        initComponents();
        ...
        for(WorkRequest w : ci.getWorkQueue().getWorkRequestList()){
    ...
    private void initComponents() {
        ...
        enterpriseLabel.setText("Cloth Institution Donation Work Area:");
        ...
        if (selectedRow < 0){
            ...
            else
            {
                ...
                if(ci.getName().equals(itemname)){
                    ...
                    ci.setInventory(quantity+donatequantity);
                }
